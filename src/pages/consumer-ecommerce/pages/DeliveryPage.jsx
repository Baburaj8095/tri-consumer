...
const rail = [
  ...
  ['Bill Payments', LuCreditCard],
  ['Travel Booking', LuPlane],
  ['Flight Tickets', LuTicket],
  ['Hotels', LuBed],
  ['Insurance', LuShield],
  ['Healthcare', LuActivity],
  ['Fresh Vegetables', LuApple],
  ['Home Appliances', LuTv],
  ['Gaming Zone', LuGamepad],
  ['Subscription Services', LuSparkles],
  ['Event Booking', LuCalendar],
  ['Fitness & Gym', LuDumbbell],
  ['Education', LuGraduationCap],
  ['Digital Services', LuCpu],
  ['Gift Store', LuGift],
  ['Furniture Deals', LuSofa],
  ['Auto Accessories', LuCar],
  ['Beauty Products', LuSparkles],
  ['Baby Care', LuBaby],
  ['Organic Products', LuSprout],
  ['Stationery', LuPenTool],
  ['Books & Media', LuBookOpen],
  ['Local Services', LuWrench],
  ['Electronics Repair', LuHammer],
  ['Laundry Services', LuShirt],
  ['Courier Services', LuPackage],
];
